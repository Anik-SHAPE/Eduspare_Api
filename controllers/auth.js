...
exports.SignUp=(req,res)=>{
    ...
    exports.SignIn=(req,res)=>{
         ...
         User.findOne({email},(err,user)=>{
             ...
             const {_id,firstname,email,role,pannelID}=user;
             return res.json({
                 token,
                 user:{_id,firstname,email,role,pannelID}
             });
...
exports.isAdminInstituteTeacher=(req,res,next)=>{
    if(req.mProfile.role===0 || req.mProfile.role===1 || req.mProfile.role===2){
        next();
    }else{
        return res.status(403).json({
            error: "Acess denied"
...
exports.isAdminInstitute=(req,res,next)=>{
